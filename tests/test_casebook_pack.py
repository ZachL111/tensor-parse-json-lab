"""Regression checks for the tensor-parse-json-lab casebook."""
...
from casebook.harness import assert_expected, tensor_parse_json_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tensor_parse_json_lab_summary(), assert_expected())
