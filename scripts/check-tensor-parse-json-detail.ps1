...
$repo = "tensor-parse-json-lab"
$language = "Ruby"
$category = "Parsers"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/tensor-parse-json-walkthrough.md")) {
