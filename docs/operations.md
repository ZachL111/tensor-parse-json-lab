...
`tensor-parse-json-lab` is centered on parsers work in Ruby. The technical target is: Implement a Ruby parsers project for json protocol validation, using framed sample traffic and bounds and ordering tests.
...
The score is deterministic. The current threshold is 161. Risk has a penalty of 7, latency has a penalty of 2, and weight contributes a bonus of 2.
